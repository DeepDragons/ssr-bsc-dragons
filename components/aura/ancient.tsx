...
export var AncientAura: React.FC<Prop> = function ({
  id,
  color,
  url,
  width = 250,
  ...
  return (
    <svg width={width} height={height} viewBox="0 0 282 283" fill="none">
      <path
      ...
      <path
        ...
        strokeWidth="2"
      />
      <circle cx="141" cy="142" r="116" fill="var(--black-color)" />
      <circle
        cx="141"
        cy="142"
        r="116"
      ...
      <defs>
        <pattern
          ...
          height="1"
        >
          <use xlinkHref={`#dragon-${id}`} transform="scale(0.00399)" />
        </pattern>
